...
final class LazyQueryLoaderTest extends TestCaseWithProphecy
{
    ...
    public function it_generate_events(): void
    {
        ...
        $this->builder->lazy(100)->willReturn(new LazyCollection([$event]))->shouldBeCalled();
        ...
        $loader = new LazyQueryLoader($this->eventConverter->reveal(), 100);
